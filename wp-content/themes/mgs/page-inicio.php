...
<!--************** Info **************-->
      <div class="container banner-home-info">
        <h1 class="white-text m-b-none">Experiencias digitales para la transformación</h1>
        <!-- <h2 class="m-t-n-xs">
        ...
        <a href="#contactForm" class="btn btn-white btn-outline text-uppercase m-md std-btn-mgs">Contáctanos
      ...
      <div class="row">
        <div class="col-xs-12 col-xs-offset-0 col-sm-12 col-sm-offset-0 col-md-12 col-lg-12">
          <section>
            <header>
              <h2 class="m-b-sm">
                En metagraphos, innovamos para transformar el conocimiento y la productividad en tu organización.
              </h2>
            </header>
            <p class="big">Creamos nuevas formas para trabajar, comunicarse y aprender día con día.</p>
            <p class="big Normal400Italic gray-light-text m-t-n-sm somos-meta">Somos metagraphos y vamos más allá.</p>
            <a href="acerca-de" class="btn btn-black text-uppercase m-t-md std-btn-mgs">Conoce más
              ...
              <section class="mgs-ux p-r-lg p-l-lg">
                <header>
                  <h2 class="Normal400 m-b-lg less-h2">
                    Fusionamos el diseño y la tecnología para crear soluciones bellas, inteligentes y fáciles de usar.
                  </h2>
                </header>
                <p class="big">Trabajamos con pasión para hacer realidad tus ideas.</p>
                <p class="big Normal400Italic gray-light-text m-t-n-sm somos-meta">Nacimos creativos, digitales, globales.</p>
    ...
    <div class="container our-team">
      ...
      <div class="row">
        <div class="col-sm-12">
          <section>
            <header>
              <h3 class="Medium500 m-b-lg">Servicios <span class="foot-hide">y Productos</span></h3>
            </header>
                ...
                <a href="e-learning">
                  <figure class="member yellow">
                    ...
                    <figcaption class="white-text c-m full-width p-sm">
                      ...
                      <p class="text-xl">Experiencias digitales para <br>el Conocimiento</p>
                    </figcaption>
...
<!-- Aplicaciones web -->
              <div class="member-container figure-overlay col-sm-6 col-md-4 p-none">
                <a href="aplicaciones-web" class="white-text light300">

                  <figure class="member yellow">
                    <img class="img-responsive full-width" src="wp-content/uploads/2016/04/produc_service_2.jpg"
                         alt="Ernesto Riestra CTO / Fundadora" />
                    <figcaption class="white-text c-m full-width p-sm">
                      <span class="medium light300">Aplicaciones Web</span>
                      <p class="text-xl">Experiencias digitales para <br>la Productividad</p>
                    </figcaption>
                ...
                <a href="consultoria">
                  <figure class="member yellow">
                    ...
                    <figcaption class="white-text c-m full-width p-sm single">
                      <span class="medium light300">Consultoría</span>
                      <p class="text-xl">Experiencias de transformación organizacional</p>
                    </figcaption>
...
<!-- Porta 3D -->
              <div class="member-container figure-overlay col-sm-6 col-md-4 p-none foot-hide">
                <a href="porta3d" class="white-text light300">
                <figure class="member yellow">
                  ...
                  <figcaption class="white-text text-center c-m full-width p-sm">
                    <span class="medium light300">Cinco variables, una sola gráfica</span>
...
<!-- Documentación 4D móvil -->
              <div class="member-container figure-overlay col-sm-6 col-md-4 p-none foot-hide">
                <a href="virtual-bullet-time">
                <figure class="member yellow">
                  <img class="img-responsive full-width" src="wp-content/uploads/2016/04/produc_service_5.jpg"
                       alt="Ernesto Riestra CTO / Fundadora" />
                  <figcaption class="white-text text-center c-m full-width p-sm">
                    <span class="medium light300">Simulación y aprendizaje 4D móvil </span>
              ...
              <div class="member-container figure-overlay col-sm-6 col-md-4 p-none foot-hide">
                ...
                <figure class="member yellow">
                  <img class="img-responsive full-width" src="wp-content/uploads/2016/04/produc_service_6.jpg"
                       alt="Ernesto Riestra CTO / Fundadora" />
                  <figcaption class="white-text text-center c-m full-width p-sm">
                    <span class="medium light300">Laberintos 3D... ¡con un giro!</span>
...
<!-- Blog -->
              <div class="member-container col-sm-4 redes-col">
                <h4 class="nowrap">En el mgsroom</h4>
                ...
                <div class="feed-blog">
                  <?php
                    ...
                    echo '<h1>'.$title.'</h1>';
                    echo '<p>'.$small_post.'...</p>';
                    echo "</br><a target='_blank' class='btn btn-outline btn-black text-uppercase m-t-md std-btn-mgs leer-mas' href='$link'>Leer más</a>"; 
                  ?>
                </div>
...
<!-- Newsletter -->
              <div class="member-container col-sm-4 redes-col newsletter">
                ...
                <p class="lead m-t-sm Normal400">Únete y recibe información relevante sobre tendencias en diseño y tecnología para tu organización.</p>
                ...
                <form id="newsletter-new" action="//metagraphos.us13.list-manage.com/subscribe/post?u=1386e87066bd330beb97f3aad&amp;id=8bb8977050" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                  <div class="col-xs-8 col-sm-9 col-md-10">
                   <input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="Escribe tu corre aquí..." required>
